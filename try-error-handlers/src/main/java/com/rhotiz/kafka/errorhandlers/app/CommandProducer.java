...
public class CommandProducer {
    ...
    public void sendCommands() {
        ...
        MyCommand myCommand1 = new MyCommand(executionId, commandId++, 0);
        System.out.println("Sending " + myCommand1);
        kafkaTemplate.send(Constants.TOPIC, myCommand1);

        MyCommand myCommand2 = new MyCommand(executionId, commandId++, 1);
        System.out.println("Sending " + myCommand2);
        kafkaTemplate.send(Constants.TOPIC, myCommand2);

        MyCommand myCommand3 = new MyCommand(executionId, commandId++, 0);
        System.out.println("Sending " + myCommand3);
        kafkaTemplate.send(Constants.TOPIC, myCommand3);
    }
}
